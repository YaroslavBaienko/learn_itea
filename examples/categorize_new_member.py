...
# handicaps range from -2 to +26; the better the player the lower the handicap. Input
#
# Input will consist of a list of pairs. Each pair contains information for a single potential member. Information
# consists of an integer for the person's age and an integer for the person's handicap. Output
#
# Output will consist of a list of string values (in Haskell and C: Open or Senior) stating whether the respective
# member is to be placed in the senior or open category. Example
#
...
arrarr = [(15, 20), (54, 14), (35, -2), (57, 12)]
print(open_or_senior(arrarr))
